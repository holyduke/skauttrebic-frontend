      ...
      <v-col cols="12" md="6">
        <v-card
          ...
          <section class="video-container">
            <iframe class="video" src="https://www.youtube.com/embed/RcIg3_yEX7Y" frameborder="0" height="200px" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe> 
          </section>
        </v-card>
        <v-card
          elevation="4"
